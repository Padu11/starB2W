...
public final class Constants {
	...
	public static final String PLANET_NOT_CREATED = "It was not possible to create the new planet.";
	...
	public static final String NOT_POSSIBLE_DELETE_PLANET = "It was not possible to delete the planet.";
	...
	public static final String MOVIE_APPEARANCES_NOT_FOUND = "It was not possible to identify the number of appearances.";
	...
	public static final String CLIMATE_INVALID = "Please enter a valid climate.";
